...
The traditional model constitutes an Extreme Gradient Boosting (XGBoost) and utilizes manually extracted audio features from the audio signals to make emotional predictions.
